...
Look at the [releases](https://github.com/dapperlinux/dapper-secure-kernel-patchset-stable/releases) page to download the latest patch and GPG signiture.
...
| Resolve Merge Conflicts to Minor Release         | Completed |
